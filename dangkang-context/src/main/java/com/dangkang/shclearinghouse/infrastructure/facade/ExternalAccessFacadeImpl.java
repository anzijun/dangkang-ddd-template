package com.dangkang.shclearinghouse.infrastructure.facade;

import com.dangkang.report.domain.facade.CallRequest;
import com.dangkang.report.domain.facade.CallResult;
import com.dangkang.report.domain.facade.ExternalAccessFacade;
import com.dangkang.report.domain.facade.QueryResult;
...
import com.dangkang.shclearinghouse.infrastructure.config.ExternalConfig;
...
public class ExternalAccessFacadeImpl implements ExternalAccessFacade {
    ...
    public CallResult call(CallRequest callRequestDto) {
        ...
        try {
            ...
            if(NetErrorManager.isReadTimeout(e)){
                com.dangkang.report.domain.facade.QueryRequest queryRequestDto = getQueryRequestDto();//查询请求所需要的数据
    ...
    public QueryResult query(com.dangkang.report.domain.facade.QueryRequest queryRequestDto){
    ...
    private com.dangkang.report.domain.facade.QueryRequest getQueryRequestDto(){
        //todo 由上下文生成查询call执行结果的请求数据
        return new com.dangkang.report.domain.facade.QueryRequest();
    }
